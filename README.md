...
3. **Full Moon**: *Maximum Illumination, Big Wins & Harvest Celebrations*
4. **Waning Moon**: *Wisdom Synthesis, The Sacred "No", Strategic Purging & Restoration*

---

## Key Features

- **Accurate Astronomical Engine**: Client-side Julian Day Number and synodic month calculations computed in pure JavaScript (`lunar_data.js`).
- **Interactive Lunar Calendar**: Multi-month interactive calendar with quick navigation to upcoming New, Waxing, Full, and Waning cycles.
...
│   └── extract_activation_knowledge.py
├── architecture/               # System architecture documentation
├── Transcripts copy/           # Raw voice transcripts & wisdom source material
...
&copy; Soul Coding. Grounded celestial intelligence for high-leverage business leadership.
